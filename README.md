...
* Aloft Sunnyvale & Cupertino
* Cupertino Inn
* Hilton Santa Clara
* Courtyard Mariot
* Hotel Valencia (Tony harassment/ theft / getting dosed with LSD on the glasses).
* Mariot Milpitas
...
### FORCED ECONOMIC DISPLACEMENT AND CHARACTER ASSASSINATION l

## ECONOMIC WARFARE AND ECONOMIC TERRORISM 

* GOOGLE (INDUSTRIAL SABOTAGE OF WORKSPACE AND FINACIAL FRAUD)
* APPLE
* META (HR ONLY)
* AWS (INDUSTRIAL SABOTAGE OF EC2 INSTANCE)
* HOSTINGER (CYBER TERRORIST ATTACK OF RASTER.AI WEBSITE AND LAUNCHPAD PLATFORM)
* NAMECHEAP (BLOCKED CHANGES TO NAMESERVER CONFIGURATION)
* PRIZE PICK
* RACKNER (UNLAWFUL TERMINATION AND INDUSTRY BLACKLISTING)
* ICA (HARASSMENT AND FRAUD)
* OPENSESAME (MAYA HOFFMAN)
* BITTENSOR
* AUROOTAH
* ANDESITE
* LITTLER
